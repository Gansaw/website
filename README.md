...
```
website/
├── index.html          # 메인 페이지 (About me / Skills / Career / Contact)
...
### 🏠 index.html — 메인 페이지
About me, Skills, Career, Contact 섹션으로 구성된 단일 페이지입니다.  
상단 네비게이션에서 About me / Project / Article / Certificate / Contact로 직접 이동할 수 있습니다.
...
### ✍️ WYSIWYG 에디터 (project / article / diary)
...
| 동작 | 커밋 메시지 |
|---|---|
| 새 항목 등록 | `✍️ Add project/article/certificate/diary: <제목>` |
| 항목 수정 | `✏️ Edit project/article/certificate/diary: <제목>` |
| 항목 삭제 | `🗑 Delete project/article/certificate/diary: <제목>` |
...
3. 발급된 토큰 입력 후 **💾 저장** 클릭
   ...
   - 각 페이지(project / article / certificate / diary)는 별도의 토큰 키로 저장됩니다.
